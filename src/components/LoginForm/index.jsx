        ...
        <div>
            ...
            >
                <form className="flex flex-col justify-center items-center bg-white px-12 h-[400px] rounded-md shadow-md">
                    ...
                    <p className="mt-4">
                        Não possui login?{" "}
                        <a className="text-blue-600 hover:cursor-pointer" onClick={() => setIsModalOpen(true)}>Cadastre-se</a>
                    </p>
                    <div className="flex justify-between mt-2 text-sm">
                        <button onClick={() => toast.info("function WIP")} className="text-blue-600 hover:cursor-pointer">Esqueceu sua senha?</button>
                    </div>
                </form>
            </section>
